# ruby-landing-page-tutorial
Ruby App Tutorial: Building Landing Pages from Scratch with ButterCMS

## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [Ruby App Tutorial: Building Landing Pages from Scratch with ButterCMS](https://buttercms.com/blog/ruby-app-tutorial-building-landing-pages-with-buttercms/), and will not be actively maintained.
